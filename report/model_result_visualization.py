...
bfmt(ax)
ax.set_title("WS, RP, and EEV comparison")
plt.tight_layout()
...
bfmt(ax)
ax.set_title("Cost component decomposition by scenario (RP)")
plt.tight_layout()
...
ax.set_title("Empirical cost CDF")
plt.tight_layout()
...
ax1.set_title("Mean cost and probability by weather severity")
plt.tight_layout()
...
fig.suptitle("Stage 1 optimal procurement portfolio", y=1.01)
plt.tight_layout()
